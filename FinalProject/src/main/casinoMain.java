...
public class casinoMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("   000                000          000    00000000000000         000000        0000000000000000   000         000");
...
//			System.out.println("Could not identify a game.");
		System.out.println("Would you like to play again? (1 to quit, 2 to play again)");
		quit = input.nextInt();
