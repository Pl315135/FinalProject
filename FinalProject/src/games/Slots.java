...
//		(1/2) + (1/4)+ (1/8) + (1/20) + (1/24) + (1/32) + (1/480)
	...
	public static void slots(int number) {
		...
		System.out.println("           000000000000000000000   0    0 1 = 10                  5 = 2000  0");
		System.out.println("         000000000000000000000     0    0 2 = 25                  6 = 3000  0");
		System.out.println("       000000000000000000000       0    0 3 = 50                  7 = 10000 0");
		System.out.println("       0                   0       0    0 4 = 75                            0");
